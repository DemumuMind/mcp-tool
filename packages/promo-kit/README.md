<p align="center">
  <img src="https://raw.githubusercontent.com/DemumuMind/mcp-tool/main/logo.png" width="420" alt="DemumuMind logo" />
</p>

<h1 align="center">@demumumind/promo-kit</h1>

<p align="center"><code>Formerly @demumumind/promo-kit</code></p>
...
<p align="center">
  <a href="https://www.npmjs.com/package/@demumumind/promo-kit"><img src="https://img.shields.io/npm/v/@demumumind/promo-kit?style=flat-square&color=cb3837" alt="npm version" /></a>
  <a href="https://github.com/DemumuMind/mcp-tool/releases"><img src="https://img.shields.io/github/v/release/DemumuMind/mcp-tool?style=flat-square&label=release" alt="GitHub release" /></a>
  <a href="https://github.com/DemumuMind/mcp-tool/blob/main/packages/promo-kit/LICENSE"><img src="https://img.shields.io/npm/l/@demumumind/promo-kit?style=flat-square" alt="license" /></a>
</p>
...
```js
import { getConfig, getRoot } from "@demumumind/promo-kit/config";
```
...
Example outputs: [trust receipt](https://github.com/DemumuMind/mcp-tool/blob/main/docs/examples/trust-receipt.json)  |  [drift report](https://github.com/DemumuMind/mcp-tool/blob/main/docs/examples/decision-drift.json)  |  [recommendations](https://github.com/DemumuMind/mcp-tool/blob/main/docs/examples/recommendations.json)
...
- [Quickstart](https://github.com/DemumuMind/mcp-tool/blob/main/docs/quickstart.md) -- zero to trust receipt in 5 minutes
- [Portable Core docs](https://github.com/DemumuMind/mcp-tool/blob/main/docs/portable-core.md) -- contract + field reference
- [Presskit Handbook](https://github.com/DemumuMind/mcp-tool/blob/main/docs/presskit-handbook.md) -- assets + verification walkthrough
- [Trust Center](http://localhost:4321/trust/) -- live example of the verification UX
