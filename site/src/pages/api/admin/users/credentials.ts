...
import { handleAdminError, jsonOk, readJsonBody, requireAdmin, requireCsrf, requireIdempotencyKey } from "../../../../lib/admin/http.mjs";
...
export const POST: APIRoute = async (context) => {
  try {
    ...
    const user = await setAdminUserPassword(body.email, body.password, process.env, { idempotencyKey });
    return jsonOk({ user });
  } catch (error) {
