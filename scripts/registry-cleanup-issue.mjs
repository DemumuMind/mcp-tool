 ...
 *   REGISTRY_REPO — target repo (default: DemumuMind/mcp-tool-registry)
...
const REGISTRY_REPO =
  process.env.REGISTRY_REPO || "DemumuMind/mcp-tool-registry";
...
function buildIssueBody(cleanup) {
  ...
  lines.push(
    ...
    "",
    "This issue is auto-generated by the [DemumuMind sync](https://github.com/DemumuMind/mcp-tool) workflow.",
